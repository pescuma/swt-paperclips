...
public class Snippet6 implements Print {
  private Print createPrint () {
    ...
    // Page footer showing a horizontal rule with a copyright statement and page number underneath.
  ...
  public static void main(String[] args) {
    ...
    button.addListener(SWT.Selection, new Listener() {
      public void handleEvent (Event event) {
        ...
        if (printerData != null) {
          PrintUtil.printTo ("Snippet6.java", printerData, print, 72); // 72 = 72 points = 1" margin
        }
      }
    });
