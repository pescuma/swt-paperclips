...
public class GridPrintExample extends FactoryPrint {
  ...
  protected Print createPrint() {
    ...
    grid.add( SWT.CENTER, new TextPrint( "LOTS AND LOTS AND LOTS AND LOTS AND LOTS OF TEXT",
                                         fontData,
    ...
    child.add( new TextPrint( "This is a line with lots of text.  Where is all this text coming from??",
                              fontData ) );
