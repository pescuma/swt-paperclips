 ...
 * PrintJob will look like on paper, depending on the selected printer.
 * <dl>
 * <dt><b>Styles:</b></dt>
 * <dd>(none)</dd>
 * <dt><b>Events:</b></dt>
...
public class PrintPreview extends Canvas {
  ...
  /**
   * Calculates the absolute scale that the print preview is displaying at. If either of the fitHorizontal or
   * fitVertical properties are true, this is the scale allows the page to fit within this control's current
   * bounds. Otherwise the value of the scale property is returned.
   * 
  ...
  /**
   * Returns a Rectangle whose x, y, width, and height fields respectively indicate the margin at the left,
  ...
  /**
   * Returns a Point whose x and y fields respectively indicate the horizontal and vertical spacing between
  ...
  private Point getBoilerplateSize() {
    return new Point( margins.x + margins.width + ( horizontalPageCount - 1 ) * pageSpacing.x, margins.y
        + margins.height + ( verticalPageCount - 1 ) * pageSpacing.y );
  }
