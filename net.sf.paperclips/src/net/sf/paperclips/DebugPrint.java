...
/**
 * Helper Print for debugging documents which fail to layout. Clients may set breakpoints inside the
 * methods in this class (as well as DebugIterator and DebugPiece), then step into the target
 * object's methods to trace the problem.
 * 
 * @author Matthew Hall
...
public class DebugPrint implements Print {
  ...
  /**
   * @param target the Print object to debug
   */
