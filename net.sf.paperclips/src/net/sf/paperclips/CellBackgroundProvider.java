...
/**
 * Instances of this interface provide background colors to be drawn behind cells in a grid. This interface
 * is used by DefaultGridLook to provide pluggable cell background behavior.
 * @author Matthew Hall
 */
public interface CellBackgroundProvider {
   ...
   * @param column the column index (zero-based). This is the grid column index, not the cell index within
   *        the row.
