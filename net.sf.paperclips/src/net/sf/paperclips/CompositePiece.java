 ...
 * implementations that perform layout of multiple child Prints.
 * @author Matthew Hall
 */
public class CompositePiece implements PrintPiece {
  ...
  /**
   * Constructs a CompositePrintPiece with the given entries and explicit size. This constructor will
   * increase the explicit size to completely contain any child entries which extend outside the given size.
   * @param entries an array of entries that make up this PrintPiece.
   * @param size
   */
   ...
   * @param entries a list of CompositeEntry objects describing the child PrintPieces.
   * @param size a hint indicating the minimum size that should be reported from getSize(). This constructor
