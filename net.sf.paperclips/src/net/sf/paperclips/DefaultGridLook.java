...
public class DefaultGridLook implements GridLook {
  ...
  /**
   * Sets the border spacing, in points, between adjacent grid cells. A value of {@link #BORDER_OVERLAP}
   * causes the borders to overlap, making the border appear continuous throughout the grid. A value of 0 or
   * more causes the cell borders to be spaced that many points apart. 72 points = 1".
   * @param cellSpacing a point whose x and y elements indicate the horizontal and vertical spacing between
   *        grid cells.
   */
  ...
  /**
   * Returns a rectangle whose public fields denote the left (x), top (y), right (width) and bottom (height)
   * cell padding, expressed in points. 72 points = 1" = 2.54cm.
   ...
   * @param horizontalPadding the amount of padding to add to the left and right of each cell, in points.
   ...
   * @param headerBackground the new background color. If null, the body background color will be used.
   */
  ...
  /**
   * Sets the vertical gap between the header and body cells. A value of {@link #BORDER_OVERLAP} causes the
   * borders to overlap, making the border appear continuous in the transition from the header cells to the
   * body cells.
  ...
  /**
   * Sets the vertical gap between the header and body cells. A value of {@link #BORDER_OVERLAP} causes the
   * borders to overlap, making the border appear continuous in the transition from the body cells to the
   * footer cells.
   * @param footerGap
   */
   ...
   * @param footerBackground the new background color. If null, the body background color will be used.
   */
