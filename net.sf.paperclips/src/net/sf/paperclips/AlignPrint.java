 ...
 * when the vertical alignment is SWT.CENTER or SWT.BOTTOM, and horizontally greedy when the horizontal
 * alignment is SWT.CENTER and SWT.RIGHT.
 * @author Matthew Hall
 */
public class AlignPrint implements Print {
   ...
   * @param hAlign the horizontal alignment. One of SWT.LEFT, SWT.CENTER, SWT.RIGHT, or SWT.DEFAULT.
