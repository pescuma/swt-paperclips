 ...
 * (no more than one child per page, although one Print may span several pages).
 * <p>
 * Use this class as the top-level Print when several distinct Prints should be batched into one print job,
 * but printed on separate pages.
 * @author Matthew Hall
 */
