...
public abstract class FactoryPrint implements Print {
  ...
  /**
   * Compose and return a Print appropriate for the concrete class. Subclasses must override this method to
   * create the Print.
  ...
  /**
   * Converts the argument to a String. This method is used by the TextPrint factory methods which accept an
   * Object.
  ...
  /**
   * Returns the default text font. All TextPrints returned from the text(...) methods are set to this font.
   * This implementation uses TextPrint.DEFAULT_FONT_DATA as the default text font. Override this method to
  ...
  /**
   * Returns the default label font. All TextPrints returned from the label(...) methods are set to this
   * font. This implementation uses TextPrint.DEFAULT_FONT_DATA as the default label font. Override this
  ...
  /**
   * Returns the default spacing, in points, for GridPrints. All GridPrints returned from the grid(String)
   * method(s) have their vertical and horizontal spacing set to this value. This implementation returns 0 as
   * the default spacing. Override this method to change the default grid spacing.
  ...
  /**
   * Returns a TextPrint whose text represents the given parameter. The returned object will be set to the
   * default text font.
   * @param obj the object that the returned TextPrint will represent.
   ...
   * default text font.
   * @param obj the object that the returned TextPrint will represent.
   * @param align the alignment property for the returned TextPrint.
   * @return a TextPrint whose text represents the given parameter.
   * @see #convertToString(Object)
   * @see #getDefaultTextFont()
   */
   ...
   * @param text the text property for the returned TextPrint
  ...
  /**
   * Returns a TextPrint with the given text and alignment. The returned object will be set to the default
   * text font.
   * @param text the text property for the returned TextPrint
   * @param align the alignment property for the returned TextPrint.
  ...
  /**
   * Returns the default image DPI. All ImagePrints returned from the image(...) methods are set to this DPI.
   * This implementation uses (300, 300) as the default DPI. Override this method to change the default image
   * DPI.
  ...
  /**
   * Creates and returns an ImageData using the given filename. All ImagePrints returned from the image(...)
   * methods are set to this DPI. This implementation uses the ImageData(String filename) constructor to
   ...
   * @param filename the filename of the image to load.
   * @param dpi the DPI at which the image is to be printed.
  ...
  /**
   * Returns an ImagePrint with the given image, and the default DPI.
   * @param is an input stream the image will be loaded from.
  ...
  /**
   * Returns an ImagePrint with the given image and DPI.
   * @param is an InputStream which the image will be loaded from.
   * @param dpi the DPI the image will be printed at.
   * @return an ImagePrint with the given image and DPI.
   */
   ...
   * @param imageData the ImageData of the image to print.
  ...
  /**
   * Returns a GridPrint with columns using the given argument. The returned object will have the horizontal
   * and vertical cell spacing set to the default spacing.
   * @param columns comma-separated list of column specs.
  ...
  /**
   * Returns a GridPrint with the given columns and spacing. The returned object will have the horizontal and
   * vertical cell spacing set to the default spacing.
   * @param columns comma-separated list of column specs.
   * @param spacing the spacing, in points, between cells in he GridPrint.
