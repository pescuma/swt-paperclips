...
public abstract class FactoryPrint implements Print {
   ...
   * TextPrint.DEFAULT_FONT_DATA as the default text font. Override this method
  ...
  /**
   * Returns the default label font. All TextPrints returned from the label(...)
   * methods are set to this font. This implementation uses
   * TextPrint.DEFAULT_FONT_DATA as the default label font. Override this method
   * to change the default label font.
   ...
   * returned from the grid(String) method(s) have their vertical and horizontal
   * spacing set to this value. This implementation returns 0 as the default
   * spacing. Override this method to change the default grid spacing.
  ...
  /**
   * Returns a TextPrint whose text represents the given parameter. The returned
  ...
  /**
   * Returns a TextPrint with the given text. The returned object will be set to
  ...
  /**
   * Returns a TextPrint with the given text and alignment. The returned object
   * will be set to the default text font.
   * @param text the text property for the returned TextPrint
   * @param align the alignment property for the returned TextPrint.
  ...
  /**
   * Returns a TextPrint with the given text and alignment. The returned object
   * will be set to the default label font.
   * @param text the text property for the returned TextPrint
   * @param align the alignment property for the returned TextPrint.
   * @return a TextPrint with the given text and alignment.
   * @see #convertToString(Object)
  ...
  /**
   * Returns the default image DPI. All ImagePrints returned from the image(...)
   * methods are set to this DPI. This implementation uses (300, 300) as the
   * default DPI. Override this method to change the default image DPI.
  ...
  /**
   * Creates and returns an ImageData using the given filename. All ImagePrints
   * returned from the image(...) methods are set to this DPI. This
   * implementation uses the ImageData(String filename) constructor to generate
   * the ImageData. Override this method to change this behavior.
  ...
  /**
   * Returns a GridPrint with the given columns and spacing. The returned object
   * will have the horizontal and vertical cell spacing set to the default
   * spacing.
   * @param columns comma-separated list of column specs.
