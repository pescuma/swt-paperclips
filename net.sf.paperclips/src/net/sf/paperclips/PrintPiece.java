...
/**
 * A piece of a Print, which is capable of drawing itself on a graphics device. PrintPiece objects are
 * created by a PrintIterator.
 * @author Matthew
 */
public interface PrintPiece {
  ...
  /**
   * Disposes the system resources allocated by this PrintPiece. The dispose method is <b>not</b> a
   * permanent disposal of a PrintPiece. It is intended to reclaim system resources, however future calls to
