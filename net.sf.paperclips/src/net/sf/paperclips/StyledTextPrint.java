...
public class StyledTextPrint implements Print {
  ...
  /**
   * Appends the given text to the end of the document, using the default style. This method is equivalent to
   * calling append(text, getStyle()).
  ...
  /**
   * Appends a line break to the document. If a line break produces a blank line, that line will take the
   * height of the font in the default text style.
   * @return this StyledTextPrint, for chaining method calls.
   */
  ...
  public PrintIterator iterator( Device device, GC gc ) {
    return new StyledTextIterator( (Print[]) elements.toArray( new Print[elements.size()] ), device, gc );
  }
}
