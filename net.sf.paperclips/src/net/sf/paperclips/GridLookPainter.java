...
public interface GridLookPainter {
   ...
   * @param topOpen whether the top body row should be drawn with the top edge of the cell border "open." An
   ...
   * permanent disposal of a GridLookPainter. It is intended to reclaim system resources, however future
