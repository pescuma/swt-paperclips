...
public interface GridLookPainter {
   ...
   * @param x the x coordinate of the top-left of the grid.
   * @param y the y coordinate of the top-left of the grid.
   * @param columns the column widths.  The left and right margins of each cell are included in
   *        the column widths.
   ...
   * @param bodyCellSpans a two-dimensional array of cell spans in the body.  Each element in the
   *        outer array is a body row.  Each element of an inner array is a cell, where the element
   *        value indicates how many columns the cell spans.
   * @param bottomOpen whether the bottom body row should be drawn with the bottom edge of the cell
   *        border "open."  An open bottom border is a visual indication that the bottom row will
   *        be continued on the next page.
   * @param footerRows the footer row heights.
   * @param footerCellSpans a two-dimensional array of cell spans in the footer.  Each element in
   *        the outer array is a footer row.  Each element of an inner array is a cell, where the
   *        element value indicates how many columns the cell spans.
   */
  ...
  /**
   * Disposes the system resources allocated by this GridLookPainter.  The dispose method is
   * <b>not</b>  a permanent disposal of a GridLookPainter.  It is intended to reclaim system
