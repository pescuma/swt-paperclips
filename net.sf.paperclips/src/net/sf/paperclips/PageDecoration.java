...
/**
 * An interface for creating page decorations. Instances of this interface are used as headers and footers in
 * conjunction with the PagePrint class.
 * @see PagePrint
...
public interface PageDecoration {
   ...
   * @return a decorator Print for the page with the given page number, or null if no decoration is provided
   *         for the given page.
   */
