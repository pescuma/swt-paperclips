...
public interface PageNumber {
  ...
  /**
   * Returns the total number of pages. Note that this method may not return an accurate value until all
   * pages have been laid out. Therefore this method should not be used inside
