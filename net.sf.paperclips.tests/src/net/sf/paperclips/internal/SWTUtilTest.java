...
public class SWTUtilTest extends TestCase {
  ...
  public void testEqualImageData_opaque() {
    ...
    assertTrue( SWTUtil.equal( imageData, createImageData( 100, 0, (byte) 0xFF ) ) );
    assertFalse( SWTUtil.equal( imageData, createImageData( 101, 0, (byte) 0xFF ) ) );
    assertFalse( SWTUtil.equal( imageData, createImageData( 100, 1, (byte) 0xFF ) ) );
  }

  public void testEqualImageData_transparent() {
    assertTrue( SWTUtil.equal( createImageData( 100, 0xFFFFFF, (byte) 0x7F ), createImageData( 100,
                                                                                               0xFFFFFF,
                                                                                               (byte) 0x7F ) ) );
    assertFalse( SWTUtil.equal( createImageData( 99, 0xFFFFFF, (byte) 0x7F ), createImageData( 99,
                                                                                               0xFFFFFF,
                                                                                               (byte) 0xFF ) ) );
    assertTrue( SWTUtil.equal( createImageData( 100, 0x000000, (byte) 0x00 ), createImageData( 100,
                                                                                               0xFFFFFF,
                                                                                               (byte) 0x00 ) ) );
  }
