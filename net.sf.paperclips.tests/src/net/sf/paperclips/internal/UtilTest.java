...
public class UtilTest extends TestCase {
  ...
  public void testEqual_equivalentArray() {
    ...
    assertTrue( Util.equal( new boolean[] { false, true }, new boolean[] { false, true } ) );
    assertTrue( Util.equal( new Object[] { new Stub(), new Stub() }, new Object[] {
        new Stub(), new Stub() } ) );
  }
  ...
  public void testEqual_differentArray() {
    ...
    assertFalse( Util.equal( new boolean[] { false, true }, new boolean[] { false, false } ) );
    assertFalse( Util.equal( new Object[] { new Stub(), new Stub() }, new Object[] {
        new Stub(), new Object() } ) );
  }
